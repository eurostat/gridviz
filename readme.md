...
| viewer.nuts2json([value])            | Boolean                            | false   | Show NUTS boundaries using [nuts2json](https://github.com/eurostat/nuts2json)                                                                                 |
...
| viewer.reverseColorsScheme([value]) | Boolean  | false                      | Flips the current color scheme. Applies .reverse() method to the domain of the scale.                                                                                                                                                                |
