export const getCSV = function (url, callback) {
...
export const getRadianAngle = function (degreeValue) {
  return (degreeValue * Math.PI) / 180;
};

export const parseCSV = function (str) {
  var arr = [];
...
export const valueToColour = function (value, scale) {
...
export const invertNumber = function (c) {
  return -Math.abs(c);
};
