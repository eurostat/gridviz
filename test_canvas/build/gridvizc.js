...
/*!***********************************!*\
  !*** ./src/gridvizc/TiledGrid.js ***!
  \***********************************/
/*! exports provided: TiledGrid, GridTile */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class GridVizCanvas {
    ...
    constructor(opts) {
        ...
        const tg = new _TiledGrid__WEBPACK_IMPORTED_MODULE_1__["TiledGrid"]("https://raw.githubusercontent.com/eurostat/gridviz/master/assets/csv/Europe/grid_pop_tiled/1km/")
        ...
        this.cplus.redraw = function() {
            ...
            for(let xT=xTMin; xT<xTMax; xT++) {
                for(let yT=yTMin; yT<yTMax; yT++) {
                    ...
                    //get cells
                    Object(d3_fetch__WEBPACK_IMPORTED_MODULE_2__["csv"])( tg.url+xT+"/"+yT+".csv" ).then((data) => {
                        geoTile(data, gridInfo, xT, yT) //TODO move to gridtile
                        const tile = new _TiledGrid__WEBPACK_IMPORTED_MODULE_1__["GridTile"](data);
                        tiles.push(tile)
                        redrawCells(this)
                    });
        ...
        //get grid info
        Object(d3_fetch__WEBPACK_IMPORTED_MODULE_2__["json"])(tg.url+"/info.json").then((data) => {
            gridInfo = data;
            th.cplus.redraw()
        });
