...
/* harmony import */ var _Layer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Layer */ "./src/js/gridvizc/Layer.js");
/* harmony import */ var _Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Style */ "./src/js/gridvizc/Style.js");
/* harmony import */ var _Dataset__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Dataset */ "./src/js/gridvizc/Dataset.js");
/* harmony import */ var _Tooltip__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Tooltip */ "./src/js/gridvizc/Tooltip.js");
...
/* harmony import */ var _dataset_TiledGrid__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dataset/TiledGrid */ "./src/js/gridvizc/dataset/TiledGrid.js");
//@ts-check
...
class App {
    ...
    constructor(opts) {
        ...
        /** Make geo canvas
         * @type {CanvasGeo} */
        this.cg = new _CanvasGeo__WEBPACK_IMPORTED_MODULE_1__["CanvasGeo"]();
        this.cg.redraw = () => {
        ...
        this.tooltip = new _Tooltip__WEBPACK_IMPORTED_MODULE_5__["Tooltip"]()
        ...
        Object(d3_fetch__WEBPACK_IMPORTED_MODULE_0__["csv"])(toponamesURL)
            .then(
                /** @param {*} data */
                (data) => {
                    this.toponames = data;
    ...
    addLayer(dataset, styles, minZoom, maxZoom) {
        this.layers.push(new _Layer__WEBPACK_IMPORTED_MODULE_2__["Layer"](dataset, styles, minZoom, maxZoom));
        return this;
    }
    ...
    addTiledGrid(url, styles, minZoom, maxZoom, preprocess = null, cellInfoHTML = null) {
        return this.addLayer(
            new _dataset_TiledGrid__WEBPACK_IMPORTED_MODULE_7__["TiledGrid"](url, this, preprocess, cellInfoHTML).loadInfo(() => { this.cg.redraw(); }),
    ...
    addCSVGrid(url, resolution, styles, minZoom, maxZoom, preprocess = null, cellInfoHTML = null) {
        return this.addLayer(
            new _dataset_CSVGrid__WEBPACK_IMPORTED_MODULE_6__["CSVGrid"](url, resolution, preprocess, cellInfoHTML).getData(null, () => { this.cg.redraw(); }),
            styles, minZoom, maxZoom
        )
    }
...
const SegmentStyle = function (orientation, color_, length, width) {
    return new _style_SegmentStyle__WEBPACK_IMPORTED_MODULE_7__["SegmentStyle"](orientation, color_, length, width)
}


const TextStyle = function (text, color_, fontSize, fontFamily, fontWeight) {
    return new _style_TextStyle__WEBPACK_IMPORTED_MODULE_8__["TextStyle"](text, color_, fontSize, fontFamily, fontWeight)
}
