...
const getShapeColorSizeStyle = function (color, size, shape) {
    return new _style_ShapeColorSizeStyle__WEBPACK_IMPORTED_MODULE_2__["ShapeColorSizeStyle"](color, size, shape)
}
...
const getCompositionStyle = function (color, type, size) {
    return new _style_CompositionStyle__WEBPACK_IMPORTED_MODULE_4__["CompositionStyle"](color, type, size)
}
