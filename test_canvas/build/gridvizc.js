...
class App {
    ...
    addTiledGrid(url, styles, minZoom, maxZoom, preprocess = null, cellInfoHTML = null) {
        return this.addLayer(
            new _dataset_TiledGrid__WEBPACK_IMPORTED_MODULE_6__["TiledGrid"](url, this, preprocess, cellInfoHTML).loadInfo(() => { this.cg.redraw(); }),
    ...
    addCSVGrid(url, resolution, styles, minZoom, maxZoom, preprocess = null, cellInfoHTML = null) {
        return this.addLayer(
            new _dataset_CSVGrid__WEBPACK_IMPORTED_MODULE_5__["CSVGrid"](url, resolution, preprocess, cellInfoHTML).getData(null, () => { this.cg.redraw(); }),
            styles, minZoom, maxZoom
        )
    }
...
/*!**********************************!*\
  !*** ./src/js/gridvizc/index.js ***!
  \**********************************/
/*! exports provided: App, color, CSVGrid, TiledGrid, ShapeColorSizeStyle, JoyPlotStyle, CompositionStyle, SegmentStyle, TextStyle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _style_TextStyle__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./style/TextStyle */ "./src/js/gridvizc/style/TextStyle.js");
//@ts-check
...
const TextStyle = function (text, color, fontSize, fontFamily) {
    return new _style_TextStyle__WEBPACK_IMPORTED_MODULE_8__["TextStyle"](text, color, fontSize, fontFamily)
}
