...
class App {
    ...
    addTiledGrid(url, styles, minZoom, maxZoom, preprocess = null) {
        this.addLayer(
            new _dataset_TiledGrid__WEBPACK_IMPORTED_MODULE_5__["TiledGrid"](url, preprocess).loadInfo(() => { this.cg.redraw(); }),
