...
class App {
    ...
    constructor(opts) {
        ...
        Object(d3_fetch__WEBPACK_IMPORTED_MODULE_0__["csv"])(toponymsURL)
            .then(
                /** @param {*} data */
                (data) => {
                    this.toponyms = data;
