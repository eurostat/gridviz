...
!(function (n, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        ? define(['exports', 'd3-array', 'd3-interpolate', 'd3-format', 'd3-time', 'd3-time-format'], t)
        : t(((n = n || self).d3 = n.d3 || {}), n.d3, n.d3, n.d3, n.d3, n.d3)
    ...
    function l() {
        ...
        function m() {
            var e = u().length,
                ...
                f = o ? c : a,
                l = o ? a : c
            ;(n = (l - f) / Math.max(1, e - s + 2 * h)),
                p && (n = Math.floor(n)),
                (f += (l - f - n * (e - s)) * g),
                (r = n * (1 - s)),
                p && ((f = Math.round(f)), (r = Math.round(r)))
    ...
    function m(n, t, r) {
        var e = n[0],
            ...
            o = t[1]
        return (
            u < e ? ((e = g(u, e)), (i = r(o, i))) : ((e = g(e, u)), (i = r(i, o))),
            function (n) {
                return i(e(n))
            }
        )
    ...
    function k(n, r, u, i) {
        ...
        switch ((i = e.formatSpecifier(null == i ? ',f' : i)).type) {
            case 's':
                ...
                return (
                    null != i.precision || isNaN((o = e.precisionPrefix(a, c))) || (i.precision = o),
                    e.formatPrefix(i, c)
                )
            case '':
            case 'e':
            ...
            case 'r':
                null != i.precision ||
                    isNaN((o = e.precisionRound(a, Math.max(Math.abs(n), Math.abs(r))))) ||
                    (i.precision = o - ('e' === i.type))
                break
            case 'f':
            case '%':
                null != i.precision ||
                    isNaN((o = e.precisionFixed(a))) ||
        ...
        return (
            ...
            (n.nice = function (e) {
                ...
                for (l < f && ((i = f), (f = l), (l = i), (i = a), (a = c), (c = i)); p-- > 0; ) {
                    if ((i = t.tickIncrement(f, l, e)) === u) return (o[a] = f), (o[c] = l), r(o)
                    if (i > 0) (f = Math.floor(f / i) * i), (l = Math.ceil(l / i) * i)
                    else {
                        if (!(i < 0)) break
    ...
    function R(n) {
        ...
        return (
            ...
            (i.ticks = function (n) {
                ...
                } else d = t.ticks(h, g, Math.min(g - h, m)).map(u)
                return e ? d.reverse() : d
            }),
            (i.tickFormat = function (n, t) {
                if (
                    (null == t && (t = 10 === a ? '.0e' : ','),
                    'function' != typeof t && (t = e.format(t)),
                    n === 1 / 0)
                )
                    return t
                null == n && (n = 10)
    ...
    function T(n) {
        var t = n(h, h),
            r = 1
        function e() {
            return 1 === r ? n(h, h) : 0.5 === r ? n(E, L) : n(P(r), P(1 / r))
        }
        return (
    ...
    function J(n, r, e, u, i, o, a, c, f) {
        ...
        function S(r, e, u) {
            if ((null == r && (r = 10), 'number' == typeof r)) {
                ...
                return (
                    a === x.length
                        ? ((i = t.tickStep(e / _, u / _, r)), (r = n))
                        : a
                        ? ((i = (a = x[o / x[a - 1][2] < x[a][2] / o ? a - 1 : a])[1]), (r = a[0]))
                        : ((i = Math.max(t.tickStep(e, u, r), 1)), (r = c)),
                    r.every(i)
                )
            }
            return r
    ...
    function K() {
        ...
        function l(t) {
            return isNaN((t = +t))
                ? i
                : c(0 === e ? 0.5 : ((t = (u(t) - n) * e), f ? Math.max(0, Math.min(1, t)) : t))
        }
        function p(n) {
            return function (t) {
                var r, e
        ...
        return (
            (l.domain = function (r) {
                return arguments.length
                    ? (([o, a] = r), (n = u((o = +o))), (t = u((a = +a))), (e = n === t ? 0 : 1 / (t - n)), l)
                    : [o, a]
            }),
            (l.clamp = function (n) {
            ...
            (l.range = p(r.interpolate)),
            (l.rangeRound = p(r.interpolateRound)),
    ...
    function Z() {
        ...
        function m(n) {
            return isNaN((n = +n))
                ? a
                : ((n = 0.5 + ((n = +o(n)) - t) * (p * n < p * t ? u : i)),
                  s(g ? Math.max(0, Math.min(1, n)) : n))
        }
        function d(n) {
            return function (t) {
                var e, u, i
                return arguments.length
                    ? (([e, u, i] = t), (s = r.piecewise(n, [e, u, i])), m)
                    : [s(0), s(0.5), s(1)]
            }
        }
        return (
            ...
            (m.range = d(r.interpolate)),
            (m.rangeRound = d(r.interpolateRound)),
    ...
    ;(n.scaleBand = l),
        ...
        (n.scaleIdentity = function n(t) {
            ...
            return (
                ...
                (t = arguments.length ? Array.from(t, p) : [0, 1]),
                w(e)
            )
        }),
        (n.scaleImplicit = c),
        ...
        (n.scaleQuantile = function n() {
            ...
            return (
                (c.invertExtent = function (n) {
                    ...
                    return t < 0
                        ? [NaN, NaN]
                        : [t > 0 ? i[t - 1] : e[0], t < i.length ? i[t] : e[e.length - 1]]
                }),
                (c.domain = function (n) {
        ...
        (n.scaleSequentialPow = X),
        (n.scaleSequentialQuantile = function n() {
            var r = [],
                e = h
            function u(n) {
                if (!isNaN((n = +n))) return e((t.bisect(r, n, 1) - 1) / (r.length - 1))
            }
            return (
                (u.domain = function (n) {
        ...
        (n.scaleSequentialSqrt = function () {
            return X.apply(null, arguments).exponent(0.5)
        }),
        ...
        (n.scaleThreshold = function n() {
            ...
            return (
                (a.domain = function (n) {
                    return arguments.length
                        ? ((e = Array.from(n)), (i = Math.min(e.length, u.length - 1)), a)
                        : e.slice()
                }),
                (a.range = function (n) {
                    return arguments.length
                        ? ((u = Array.from(n)), (i = Math.min(e.length, u.length - 1)), a)
                        : u.slice()
                }),
